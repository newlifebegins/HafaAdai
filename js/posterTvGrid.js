	...
	posterTvGrid.prototype = {
		...
		drawContent: function(){
			...
			this.content.cssText = "width:"+this.options.width+"px;height:"+this.options.height+"px;cursor:move;position:absolute;";
				...
				$(".rotate-bg").append(this.bannerControls);
			...
			this.parent.css({overflow:'hidden',margin:'0 auto'});
			this.initContent();
			this.bind();
			this.start();
		},
		...
		bind: function(){
			this.leftNav = $(".rotate-bg").find(".leftNav");
			this.rightNav = $(".rotate-bg").find(".rightNav");
